...
type Profile struct {
	...
	CreatedOn            int32    `protobuf:"varint,3,opt,name=CreatedOn,proto3" json:"CreatedOn,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Profile) GetCreatedOn() int32 {
	if m != nil {
		return m.CreatedOn
	}
	return 0
...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0x6a, 0xb0, 0x06, 0x21, 0x04, 0x8c, 0x96, 0x30, 0x72, 0x21, 0x7b, 0x45, 0xc8, 0x97, 0x4b, 0xcc,
	...
	0x08, 0x00, 0x00, 0xff, 0xff, 0x2b, 0x4a, 0xeb, 0x01, 0x86, 0x01, 0x00, 0x00,
}
