module github.com/GuyARoss/project-orva
...
require (
	...
	github.com/truauth/truauth v0.0.0-20190918191425-840676f9947d
	...
	golang.org/x/tools v0.0.0-20191104222624-6b7b8b79ae80 // indirect
